    ...
    return (
      <div className="rp_charge" style={{paddingBottom: 100}}>
        <div className="ui segment">
          ...
          <p>
            또한, 본인이 업로드한 글의 쉐어링크를 통해서 쉐어링크를 통해 들어온 순방문자당 5 포인트씩 실시간으로
            적립됩니다.<br />
          ...
          <p>
            ...
            또, 만약 베나링크 활성화에 사용한 RP가 모두 소진되지 않더라도 남은 RP는 본인의 계정으로 모두 재 적립
            됩니다.<br /><br />
          ...
          <p>
            ...
            따라서 아래에 명시된 경우를 제외하고는 구매를 한 후에 취소 할 수있는 권한을 상실하며 결제한 이후 환불이나 크레딧을
            제공하지 않습니다.<br />
            베나클은 언제든지 아래 명시된대로 환불 정책을 수정할 권리를 보유합니다. <br />
            이용과정에 기술적 문제가 발생한 경우 고객 지원부 webmaster@venacle.com 에 문의하십시오. 고객 지원부는
            문제를 해결하기 위해 귀하와 협력합니다. 고객 지원 센터에서 문제를 해결할 수없는 경우, 구매에 대한 환불을
            처리합니다.<br />
            환불의 조건으로, 충전후 귀하의 구입한 제품과 서비스를 사용하지 않았음을 확인하기 위해 귀하에게 비사용 서비스 환불 확인
            서약을 서명하도록 요구할 수 있습니다.<br />
            환불은 원래 구매에 사용 된 결제 수단으로 환불됩니다. 환불 금액이 해당 계정에 반영되기까지 영업일 기준 5 일이 소요될
            수 있습니다.<br />
            이 베나클의 환불 정책은 구매를 의도하지 않은 경우에 도움을주기위한 것입니다. 그것은 당신이 우리 시스템을 활용할 수있는
            방법은 아닙니다. <br />
        ...
        <div className="ui segment">
          ...
          <div className="rp_charge_form">
            ...
            <div style={{textAlign: 'right'}}>
              내역 (예산 : {this.state.amount * 10 / 11}원 + VAT:{parseInt(
              this.state.amount, 10)}원)
              <br />
              총 충전 금액 : {parseInt(this.state.amount, 10)}원
            </div>
            <div style={{paddingTop: 10}}>
              <div className="ui button primary right fluid"
                   onClick={this.sendPayment}>충전하기
              </div>
            </div>
          </div>
        </div>
