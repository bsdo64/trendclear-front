...
class SimpleMap extends React.Component {
  constructor(props) {
    ...
    this.state = {
      markers: [
        {
          position: {lat: 37.5565751, lng: 126.9250385},
          key: `Taiwan`,
          defaultAnimation: 2,
        }],
    };
        ...
        <GoogleMapLoader
          ...
          googleMapElement={
            <GoogleMap
              ...
              defaultZoom={15}
              defaultCenter={{lat: 37.5565751, lng: 126.9250385}}
...
require('../../../Help/components/Help/Contact.scss');
const Contact = () => (
...
const Company = props => {
  ...
  switch (getEndpoint(props.location)) {
    case 'about':
      return <About />;
    case 'help':
      return <Contact />;
