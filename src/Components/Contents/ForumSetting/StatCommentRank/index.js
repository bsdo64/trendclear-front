      ...
      <div className="ui segments ">
        <div className="ui segment"><h3 className="ui header">게시판 생성</h3>
          ...
          <form id="create_forum" className="ui form">
            <div className="field"><label>이름 *</label><input type="text"
                                                             name="forum_title"/>
            </div>
            <div className="field"><label>작은 제목</label><input type="text"
                                                              name="forum_sub_header"/>
            </div>
            <div className="field"><label>설명 *</label><input type="text"
                                                             name="forum_description"/>
            </div>
            <div className="field"><label>규칙 *</label><textarea
              name="forum_rule"></textarea></div>
...
export default StatCommentRank;
